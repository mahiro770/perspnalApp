...
// 気象庁の地域マスタ (https://www.jma.go.jp/bosai/common/const/area.json) と突き合わせて
// 全47都道府県ぶんを1件ずつ収録(取得日: 2026-09-09)。北海道・鹿児島県・沖縄県は
// 気象庁側で県内が複数区域に分かれているため、代表区域(道庁所在地・本土・本島)を採用している。
// 変更頻度が低いため静的データとして同梱。
